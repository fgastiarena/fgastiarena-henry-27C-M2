...
// Tu código acá:
let nombreApp = document.querySelector('#createdBy');
nombreApp.innerHTML = nombreApp.innerHTML.concat(' Fernanda Gastiarena');
...
function buildToDo(todo, index) {
    ...
    todo.complete === true ? (toDoText.className = 'completeText') : (toDoText.className = 'false'); //(6)
...
function buildToDos(toDos) {
    // Tu código acá:
    let newArray = toDos.map(function(e, index) {
